...
permalink: notes-temporaires
aliases: [Fleeting note, Note éphémère]
publish: true
rss: true
links: "[[Zettelkasten]]"
---
...
Personnellement, j'ai 3 manières de prendre des note temporaires :

1. Les "Messages enregistrés" de Telegram quand je n'ai pas accès à mon PC.
2. Mon Rocketbook quand je suis sur mon bureau.
3. Un fichier markdown `inbox.md` dans Obisidian où je note tout ce qui me traverse l'esprit.
