---
title: Générer des idées de produits - Techniques actionnables pour trouver de nouvelles idées de business
permalink: generating-product-ideas-actionable-techniques-for-finding-new-business-ideas
datePublished: 2021-02-08T08:00
dateUpdated: 2021-02-08T08:00
...
| Projets | J'ai passé beaucoup de temps sur | J'ai dépensé beaucoup d'argent sur | Processus frustrants |
|---------|----------------------------------|------------------------------------|----------------------|
| #1      |                                  |                                    |                      |
| #2      |                                  |                                    |                      |
| #3      |                                  |                                    |                      |
...
- Ressources de préparation à l'entretien d'embauche pour différents rôles. ([Solving Product Design Exercises](https://productdesigninterview.com/)).
- Des autocollants pour clavier améliorant la productivité dans différentes professions. ([SketchKeys](https://sketchkeys.com/)).
- Supports pour ordinateurs portables et instruments de musique. ([OpenStanding](https://openstanding.com)).
...
Mailchimp dispose d'une fonctionnalité "[Use Send Time Optimization](https://mailchimp.com/help/use-send-time-optimization/)" qui analyse le moment où les abonnés sont les plus actifs et détermine ainsi le meilleur moment pour leur envoyer une newsletter.
...
Matias Martinez a créé une application appelée [Figurative](https://apps.apple.com/app/id1510607687) qui permet aux gens d'exécuter Figma sur iPad.

- Soundcloud

SoundCloud, un site de distribution et de partage de musique, a abandonné son macOS en raison de ressources limitées et s'est concentré sur ses applications iOS et Web. Dennis Oberhoff a vu une opportunité ici et a développé [DaftCloud](https://apps.apple.com/fr/app/daftcloud-for-soundcloud/id1320450034), une nouvelle application indépendante.
...
Vous pouvez explorer et voir quelles communautés sont populaires sur [redditlist.com](http://redditlist.com/).
...
- [Data.gov.uk](https://data.gov.uk/) - données du gouvernement britannique
- [Data.gov](https://data.gov/) - données du gouvernement américain
- [Data.europa.eu](https://data.europa.eu/) - données de l'Union européenne
- [Movement.uber.com](https://movement.uber.com/) - données d'Uber sur les temps de trajet dans les villes
- [Daten.berlin.de](https://daten.berlin.de/) - données sur Berlin
...
L'un des produits qui a été construit de cette façon est [Nomad List](https://nomadlist.com/).
...
- [keysearch.co/tools/brainstorm-niche-ideas](https://keysearch.co/tools/brainstorm-niche-ideas)

### Étape 2 : Recherchez les sujets pertinents pour votre audience

Exemples :

| Audience                            | Mots-clés recherchés                                |
|-------------------------------------|-----------------------------------------------------|
| Personnes souffrant d'un mal de dos | Douleur dorsale, claquage des muscles du dos        |
| Employés à distance                 | Travail à distance, productivité, bureau à domicile |
| Les auteurs de livres indépendants  | autoédition                                         |
| Vegans                              | Véganisme, alimentation à base de plantes           |
...
| Audience            | Problèmes | Idées de produit |
|---------------------|-----------|------------------|
| Coworkers           |           |                  |
| Auteurs auto édités |           |                  |
| Cyclistes           |           |                  |
...
- [TrendHunter.com](https://trendhunter.com/)
...
N'essayez pas d'être dans la tendance de la livraison de nourriture et de rivaliser avec BlueApron ou HelloFresh, mais cherchez les opportunités pour servir ces entreprises. [Onfleet](https://onfleet.com/) fait exactement cela en fournissant un système de gestion de livraison pour des clients comme HelloFresh, Meadow et Imperfect Food. Ils ont réalisé [un chiffre d'affaires de 4,8 millions de dollars en 2019](https://getlatka.com/companies/onfleet).

La société californienne [Packed](https://packedpkg.com/) a examiné l'explosion du marché du cannabis nouvellement légal et a décidé de le servir en fournissant des emballages de haute qualité pour les marques de cannabis.

Les podcasts sont en train de devenir une grosse affaire et il y a des entreprises qui ont reconnu cette tendance et en ont capitalisé, non pas en créant elles-mêmes des podcasts mais en fournissant des outils à ceux qui le font. Jon Buda et Justin Jackson ont construit [Transistor.fm](https://transistor.fm/), un ensemble d'outils d'analyse et de distribution pour les podcasts, avec des clients comme Basecamp, Kickstarter et Alexis Ohanian (co-fondateur de Reddit).
...
La recherche sur le thème de la productivité peut conduire à des recherches explorant [l'effet négatif des niveaux de CO2 sur les capacités cognitives humaines.](https://researchgate.net/publication/283236205_Associations_of_Cognitive_Function_Scores_with_Carbon_Dioxide_Ventilation_and_Volatile_Organic_Compound_Exposures_in_Office_Workers_A_Controlled_Exposure_Study_of_Green_and_Conventional_Office_Environ) Des niveaux élevés de CO2 au bureau ou à la maison peuvent réduire de 50% certains domaines de la performance cognitive.
...
| Composants de business modèles | Audience #1 | Audience #2 | Audience #3 | Audience #4 | Audience #5 |
|--------------------------------|-------------|-------------|-------------|-------------|-------------|
| Add-on                         |             |             |             |             |             |
| Advertising                    |             |             |             |             |             |
...
| Product Models                            | Audience #1 | Audience #2 | Audience #3 | Audience #4 | Audience #4 |
|-------------------------------------------|-------------|-------------|-------------|-------------|-------------|
| DIY kits                                  |             |             |             |             |             |
| Analytics tools                           |             |             |             |             |             |
...
- Plateformes de crowdsourcing (exemples : [Kickstarter](https://kickstarter.com/) et [Indiegogo](https://indiegogo.com/)).
- Rapports de tendances - Ces rapports explorent de nouvelles idées qui émergent et qui deviennent une tendance sur le marché. (exemples : [Trends.co](https://trends.co/) ou [TrendHunter.com](https://trendhunter.com/)).
- Rapports d'entreprises (exemple : [Statista](https://statista.com/))
...
- [Startupsfromthebottom.com/ideas](https://startupsfromthebottom.com/ideas)
- [Ideaswatch.com](https://ideaswatch.com/)
- [Openideo.com](https://openideo.com/)
- [Probstack.io](https://probstack.io/)
- [Requestforproduct.co](https://requestforproduct.co/)
- [Fiveideasaday.com](https://fiveideasaday.com/)
- [Problemoftheday.co](https://problemoftheday.co/)
...
- [Ycdb.co](https://ycdb.co/)
- [Getlatka.com](https://getlatka.com/)

## Comment hiérarchiser nos idées

### Étape 1 : Définissez vos objectifs

|                    | Weekend project | Boostrapped business | Multimillion-dollar company |
| ------------------ | --------------- | -------------------- | --------------------------- |
| Profits            | 💲              | 💲💲                 | 💲💲💲                      |
| Taille de l'équipe | 🌚              | 🌚🌚                 | 🌚🌚🌚                      |
| Compétences        | 🔧              | 🔧🔧                 | 🔧🔧🔧                      |
...
![Matrice impact / effort](https://i.imgur.com/LhYLFLW.jpg)

---

Références :

- [Artiom Dashinsky - Generating Product Ideas](https://productideasbook.com/)