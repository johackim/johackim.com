---
permalink: devenez-hebergeur-web-independant
title: Devenez hébergeur web indépendant
datePublished: 2021-05-04T08:50
dateUpdated: 2021-05-04T08:50
publish: true
comments: false
note: 81
---
...
1. [[Docker|Docker c'est quoi ?]]
2. [[Installer Docker]]
3. [[Démarrer un conteneur Docker]]
4. [[Supprimer un conteneur Docker]]
5. [[Lister les conteneurs Docker]]
6. [[Docker volumes|Créer un volume Docker]]
7. [[Entrer à l'intérieur d'un conteneur Docker]]
8. [[Spécifier la quantité de ressources d'un conteneur Docker]]
9. [[Traefik|Installer Traefik en tant que reverse proxy avec Docker]]

## II. Scalez votre infrastructure avec Docker Swarm

1. [[Docker Swarm|Docker swarm c'est quoi ?]]
2. [[Initialiser un cluster Docker Swarm]]
3. [[Service Docker|Créer un service Docker]]
4. [[Créer un service Docker avec plusieurs replicas]]
5. [[Stack Docker|Créer une stack Docker]]
6. [[Ajouter un node à un cluster Docker Swarm]]
7. [[Installer Traefik avec Docker Swarm]]
8. [[GlusterFS|Créez un espace de stockage distribué avec GlusterFS]]

## III. Sécurisez votre infrastructure

1. [[Pare-feu|C'est quoi un pare-feu ?]]
2. [[iptables|Gérez votre pare-feu avec iptables]]
3. [[IPS|Installer un IPS]]
4. [[ClamAV|Installer un anti-virus]]
5. [[Hardening|Faire du Hardening]]
6. [[Spectre|Gérer vos mots de passe avec Spectre]]
7. [[Traefik et Let's Encrypt|Créer des certificats SSL avec Traefik et Let's Encrypt]]
8. [[Restic|Installer un système de sauvegarde automatique avec Restic]]
...
1. [[Terraform|Terraform c'est quoi ?]]
