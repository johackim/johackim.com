...
Contrairement aux [[IDS|systèmes de détection d'intrusion]] qui se contentent d'analyser des données pour émettre des alertes, les IPS (ou IDPS) sont des outils permettant de bloquer une attaque.