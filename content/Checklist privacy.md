---
title: Checklist to protect your privacy
permalink: protect-your-privacy
datePublished: 2018-01-15T08:00
dateUpdated: 2018-01-15T08:00
...
The source code is here: [https://github.com/johackim/privacy-checklist](https://github.com/johackim/privacy-checklist)
...
- [ ] Disable your webcam - [disable-webcam.sh](https://gist.github.com/johackim/9092445b6b4d0a330e8c0b327aeb54ae)
- [ ] Don't use Windows 10, It's a privacy nightmare
- [ ] Keep your OS and apps update
- [ ] Use open-source operating system
- [ ] Use a secure operating system - [Tails OS](https://tails.boum.org/) or [Qubes OS](https://qubes-os.org/)

## Phone

- [ ] Use secure SMS application - [Signal](https://signal.org/)
- [ ] Use open-source Operating system - [LineageOS](https://lineageos.org/)
...
- [ ] Use open-source browser - [Firefox](https://mozilla.org/en-US/) or [Tor](https://torproject.org/)
- [ ] [Configure firefox to enhance the privacy of your browser](https://privacytools.io/#about_config)
...
- [ ] [Use disposable email addresses](https://johackim.com/meilleures-solutions-adresse-mail-jetable/)

## VPN

- [ ] [Use a vpn solution](https://privacytools.io/#vpn)
...
- [ ] Use a different DNS server than your ISP - [Check DNS leak](https://dnsleaktest.com/)
- [Disable browser location](https://ivpn.net/knowledgebase/150/My-real-location-is-detected-when-connected-to-VPN-How-to-disable-geolocation.html)

## Anti-Forensic

- [ ] Wipe unused old computers, phones, tablets, hard drives, etc - `shred -n 5 -vz /dev/sda`
- [ ] Use a cleaner - [Bleachbit](https://bleachbit.org/)
...
- [Recommended Privacy Tools](https://privacytools.io/)
