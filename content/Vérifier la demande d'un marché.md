---
title: Comment vérifier la demande d'un marché avant de créer un produit dont personne ne veut ?
...
- Plateformes de freelance comme Fiverr et Upwork
...
Petite astuce ; copiez-collez le texte de chaque page sur [wordcounter.net](https://wordcounter.net) pour avoir les mots-clés par ordre de récurrence.
...
La deuxième méthode consiste à renseigner et chercher des questions potentielles sur des **outils SEO** ([Answerthepublic](https://answerthepublic.com), [Questiondb](https://questiondb.io), [Buzzsumo](https://buzzsumo.com/), [Ahrefs](https://ahrefs.com/), [KeywordTool](https://keywordtool.io/), [Google Keyword Planner](https://ads.google.com/home/tools/keyword-planner/)[en mode anonyme](https://johackim.com/vie-privee/comment-detenir-un-compte-google-anonyme/), etc...) pour vérifier s'il existe un volume de recherche important.
...
Voici [une liste d'outils SEO](https://backlinko.com/seo-tools) pour approfondir toutes vos recherches :
...
- Un marché qui n'a pas conscience de son problème ([voir les 5 niveaux de conscience d'un prospect](https://johackim.com/copywriting/les-5-niveaux-de-conscience/)).
...
Essayez de trouver une niche où il est possible d'apparaitre en couverture du magazine n°1 pour moins de 5 000€.

Si un marché a un magazine qui lui est consacré, ça veut dire qu'il est suffisamment grand pour obtenir suffisamment de clients.

Et si une annonce pleine page coûte moins de 5 000€, le marché est suffisamment petit pour que vous puissiez l'atteindre efficacement.

## Une estimation concrète du nombre de personnes à atteindre

D'après [Rob Walling](https://robwalling.com/), un **taux de conversion** se situe en moyenne :
...
À vous de trouver un moyen d'acquérir toutes ces personnes par le moyen qui vous convient le mieux (SEO, Réseaux sociaux, Partenariats, Avertising, ect...).
