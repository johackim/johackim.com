---
title: "Mon processus de prise de notes"
links:
  - "[[Productivité]]"
  - "[[Prise de note]]"
datePublished: 2021-06-27T19:19
dateUpdated: 2021-06-27T19:19
permalink: mon-processus-de-prise-de-notes
aliases: [Mon processus de prise de notes]
publish: true
rss: true
---
...
```mermaid
graph TD;
    Temporaire["Notes temporaires"]-->Permanente["Note permanente"]
    Littéraire["Notes littéraire"]-->Permanente
```

~~Ce sur quoi mon processus diffère de la méthode [[Zettelkasten]], c'est que je transforme directement mes notes littéraires en plusieurs notes permanentes sans garder le contenu d'origine de la note littéraire pour ne pas avoir de duplications dans [[202104161250|mon second cerveau]].~~
