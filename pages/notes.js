        ...
        <section className="mt-20">
            <div className="container m-auto px-4 lg:max-w-screen-lg">
                <div className="md:border dark:border-gray-800">
                    <Article>
                        <Article.Title className="mt-0 border-t-0 border-r-0 border-l-0">Notes</Article.Title>
                        ...
                        <Article.Content className={`${styles.article} md:px-4`}>
                            {!contents.length && <p className="text-center">Aucune note pour le moment.</p>}
...
export const getStaticProps = async () => {
    const contents = (await getContents())
        ...
        .filter(({ tags }) => tags.includes('note'))
